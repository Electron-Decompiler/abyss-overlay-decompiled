...
function updateTags(){
    $.ajax({type: 'GET', async: true, url: `${dbip}/gimmeusers`, success: (data) => {
...
function getTag(api){
    ...
    try{
        ...
        else if (boosters.includes(api.id)) return '<li style="color: #D071DA">BST⬢</li>';
...
$(() => {
    ...
    //     thtml += '<li class="rainbow">𝓼𝔀𝓮𝓪𝓽</li>';
